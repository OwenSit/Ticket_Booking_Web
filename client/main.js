...
const displayReserve = () => {
  ...
  tickett.map(tickett =>{
    ...
    <th><button class="btn btn-danger" type="button" onclick="deleteCustomer(${tickett.ticket_no})">Delete</button></th>
    </tr>`;
  })
  todoTable.innerHTML = tableHTML;
...
async function insertCustomer() {
  ...
  st = fid+','+mv+','+ml+','+name+','+bg+','+price.toString()+','+dicount+','+pho+','+em;
